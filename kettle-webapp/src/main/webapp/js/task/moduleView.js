...
function showModuleView(secondGuidePanel){
    ...
    var windowHTML="<div id='moduleTitle' style='height:50px; margin-bottom:5px;position:relative;'><span style='position:absolute;left:450px;top:10px;font-size:32px;color:#2f9adb'>平台概况视图</span></div>"+
        "<div style='height:330px;display:inline-block;position:relative;'><div id='module1' style='height:300px;width:550px;display:inline-block;border-right:1px dashed #2f9adb;'></div><div style='position:absolute;top:230px;left:230px;'>运行中作业数</div></div>"+
        "<div style='height:330px;display:inline-block;position:relative;'><div id='module2' style='height:300px;width:550px;display:inline-block;border-right:1px dashed #2f9adb'></div><div style='position:absolute;top:230px;left:230px;'>运行中转换数</div></div>";
